...
function drawGunClock_hms(hour, minute, second){
	...
	if ( clockSize < 17 ) {
		...
		$("pre#GunClock").text(GunClock_hms(hour, minute, second)); 
	}
...
function makeGunClock(){
	...
	return makeGunClock_hms(hour, minute, second);
}

function makeGunClock_hms(hour, minute, second){
...
function GunClock_hms(hour, minute, second){

	initGunClock();
	makeGunClock_hms(hour, minute, second);
	return toString(strBufGunClock);
};
